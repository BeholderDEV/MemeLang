 ...
 * @author alisson
 */
public class MemeTokenMaker extends AbstractTokenMaker{
    ...
    public TokenMap getWordsToHighlight() {
        ...
        tokenMap.put("checkEm",  Token.DATA_TYPE);
        tokenMap.put("lolicon",   Token.DATA_TYPE);
        tokenMap.put("dubs",    Token.DATA_TYPE);
        tokenMap.put("yesButNo", Token.DATA_TYPE);
        tokenMap.put("binLaden", Token.DATA_TYPE);
        tokenMap.put("l33t", Token.DATA_TYPE);
        tokenMap.put("missingNo", Token.DATA_TYPE);
        tokenMap.put("batata", Token.DATA_TYPE);
